  ...
  async function fetchWalletBalance(selectedToken: Token) {
    try {
      ...
      if (provider) {
        ...
        setTokenInBalance(
          await getCurrencyBalance(provider, user, selectedToken)
        );
  ...
  return (
    <>
      ...
      <div className={styles.LogoSmall}>
        <div className={styles.instructionContainer}>
          <p className={styles.instructionText}>
            Swap your tokens for ZARP tokens here ↩️
          </p>
        </div>
      </div>
        ...
        <div>
          ...
          <p className={styles.label}>
            ...
            {txState ? (
              ...
              <span className={styles.placeholder}>Pending...</span>
            )}
          </p>
      ...
      <p className={styles.additionalText}>
        Using Stablecoins is the safest and least volatile way <br />
        to use cryptocurrency! If you want to see how trades <br />
        happen on on this swap above, visit the
        <br />
        <div>
          <p className={styles.additionalTexta}></p>
          <a
            href="https://goerli.etherscan.io/address/0xe592427a0aece92de3edee1f18e0157c05861564"
            target="_blank"
